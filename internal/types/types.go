...
type NodeConfig struct {
	...
	RelayRules             []NodeRelayRule   `json:"relay_rules"`
}
...
type ServerNodeConfigOverride struct {
	...
	InheritRelayRules bool            `json:"inherit_relay_rules"`
	RelayRules        []NodeRelayRule `json:"relay_rules"`
}
...
type RelaySubscriptionGroupRequest struct {
	Id              int64  `json:"id"`
	ServerID        int64  `json:"server_id"`
	Name            string `json:"name" validate:"required"`
	URL             string `json:"url" validate:"required"`
...
type RelaySubscriptionGroupListResponse struct {
	List  []RelaySubscriptionGroup `json:"list"`
	Total int64                    `json:"total"`
}

type RelaySubscriptionGroupRuntimeResponse struct {
	Groups []RelaySubscriptionGroup `json:"groups"`
}

type RelaySubscriptionGroupHealthResult struct {

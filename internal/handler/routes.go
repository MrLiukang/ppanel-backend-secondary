...
func RegisterHandlers(router *hertzx.Engine, serverCtx *svc.ServiceContext) {
...

	{
		...
		// Preview subscription nodes as relay rules
		adminServerGroupRouter.POST("/relay/subscription/preview", adminServer.PreviewSubscriptionRelayHandler(serverCtx))
		adminServerGroupRouter.GET("/relay/subscription/groups", adminServer.QueryRelaySubscriptionGroupsHandler(serverCtx))
		adminServerGroupRouter.POST("/relay/subscription/group/save", adminServer.SaveRelaySubscriptionGroupHandler(serverCtx))
		adminServerGroupRouter.POST("/relay/subscription/group/delete", adminServer.DeleteRelaySubscriptionGroupHandler(serverCtx))
		adminServerGroupRouter.POST("/relay/subscription/group/preview", adminServer.PreviewRelaySubscriptionGroupHandler(serverCtx))
		adminServerGroupRouter.POST("/relay/subscription/group/apply", adminServer.ApplyRelaySubscriptionGroupHandler(serverCtx))

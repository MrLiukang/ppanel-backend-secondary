...
type ServerConfigOverride struct {
	...
	RoutingMode  *string   `gorm:"type:varchar(20);comment:Routing merge mode override, NULL means inherit"`
	RoutingRules *string   `gorm:"type:text;comment:Routing rules override, NULL means inherit"`
	RelayRules   *string   `gorm:"type:text;comment:Relay rules override, NULL means inherit"`
